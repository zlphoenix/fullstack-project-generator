...
| E002 | 统计细化（需求实现过程精细化度量） | 计划侧经 plan_sync 入遥测并与 hook 实测 join；身份 id/name 分离；看板升级为下钻+并行甘特+关键路径+按用户关注/视角 | 已完成 | 2026-06-14 | 2026-06-14 | 2026-06-14 | 遥测 | 遥测 | 170k-330k | 遥测 | S001+S002 均验收通过；甘特粒度返修一次后过 | [plan](epics/E002-metrics-refinement/plan.md) ・ [design](epics/E002-metrics-refinement/design.md) |
